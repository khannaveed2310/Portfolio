...
import { Zap, FileDown, ArrowDown, ShieldCheck, Cpu, Database, Globe, Sparkles } from "lucide-react";
...
export function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen w-full flex items-center justify-center pt-24 pb-16 overflow-hidden bg-[#030712] cyber-grid"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Left Column: Brand & Hero Pitch (7 cols) */}
          <motion.div
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-cyan-500/30 text-xs font-mono backdrop-blur-md shadow-[0_0_15px_rgba(6,182,212,0.15)]"
            >
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping inline-block" />
              <span className="text-cyan-300 font-semibold tracking-wide">SYSTEM READY</span>
              <span className="text-slate-600">|</span>
              <span className="text-slate-300">OPEN FOR HIGH-IMPACT ROLES</span>
            </motion.div>

            {/* Main Name Heading with Neon Accents */}
            <div className="space-y-2">
              ...
              <div className="h-10 flex items-center">
                <span className="text-xs font-mono text-cyan-400 uppercase tracking-widest mr-2 select-none">
                  // ROLE:
                </span>
                <span className="text-base sm:text-xl font-mono font-bold text-slate-100 tracking-wider bg-slate-900/60 px-3 py-1 rounded-md border border-cyan-500/20 text-glow-cyan">
                  {decodedText}
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <Button
                ...
                size="lg"
                className="group relative overflow-hidden bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 hover:from-cyan-400 hover:to-purple-500 text-slate-950 font-bold px-7 py-6 rounded-xl shadow-[0_0_25px_rgba(6,182,212,0.4)] transition-all duration-300 border border-cyan-300/40"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-slate-700 hover:border-cyan-500/60 bg-slate-900/60 hover:bg-slate-800/80 text-slate-200 px-6 py-6 rounded-xl font-mono text-xs uppercase tracking-wider transition-all duration-300"
              >
            ...
            <div className="grid grid-cols-3 gap-3 pt-6 border-t border-slate-800/80 max-w-lg">
              ...
              <div className="p-3 rounded-xl bg-slate-900/40 border border-slate-800">
                ...
                <div className="text-[11px] text-slate-400 uppercase tracking-wider">Repositories</div>
              </div>
              <div className="p-3 rounded-xl bg-slate-900/40 border border-slate-800">
                <div className="text-xl sm:text-2xl font-bold font-mono text-emerald-400">99.9%</div>
                <div className="text-[11px] text-slate-400 uppercase tracking-wider">Uptime Focus</div>
              </div>
            </div>
          </motion.div>

          {/* Right Column: Live Interactive Developer CLI Terminal (5 cols) */}
          <motion.div
          ...
          >
            ...
            <div className="absolute -inset-1.5 bg-gradient-to-r from-cyan-500/30 via-purple-500/20 to-emerald-500/30 rounded-3xl blur-xl opacity-75 group-hover:opacity-100 transition duration-1000 -z-10" />
            <InteractiveTerminal />
          </motion.div>
